...
//exit;
  ...
  $tables[1]['id'] = 'mobilitydcat-ap-classes-and-properties';
...
// New
  ...
  $html  = '';
  if ($tv['type'] == 'ap-ext') {
    $html .= '<p>This version of mobilityDCAT-AP extends [[DCAT-AP-20200608]] with ' . $cextnr . ' additional classes and ' . count(array_unique($pext)) . ' additional properties (some of which re-used across classes). They are listed in the following table.</p>' . "\n\n";
  }
