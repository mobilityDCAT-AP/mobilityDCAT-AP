...
- The [Address_Agent_Shape](address_agent_shape.ttl) is a SHACL node shape that defines the structure and constraints for the [locn:Address]("./#properties-for-address-agent") class. <a href="#catalogue-record-source-metadata"><code>dct:source</code></a>
